...
urlpatterns = [
    ...
    path('delete-album/<uuid:albumId>/<uuid:userId>/', DeleteAlbumView.as_view(), name='delete-album'),
    path('delete-album/<uuid:albumId>//', DeleteAlbumView.as_view(), name='delete-album-without-user'),
